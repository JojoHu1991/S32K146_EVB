...
#define ADC_IP_SW_MAJOR_VERSION               3
 ...
 *  - ADC_IP_STATUS_CAL_ONGOING: calibration is ongoing (if async mode is active)
 */
...
/*!
* @brief This function configures user gain and offset.

* @param[in] Instance - ADC instance number
* @param[in] Gain - user gain of the conversion
* @param[in] Offset - user offset of the conversion
*/
