...
#define ADC_IP_SW_MAJOR_VERSION_IRQ               3
...
/* Check if Adc_Ip_Irq.h file and Std_Types.h file are of the same Autosar version */
    ...
    #error "AutoSar Version Numbers of Adc_Ip_Irq.h and Std_Types.h are different"
#endif
